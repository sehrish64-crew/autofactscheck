...
export default async function WhyTrueAutoCheck() {
  ...
  try {
    ...
    if (process.env.NODE_ENV !== 'production') console.warn('[i18n] Could not read cookies/headers in WhyTrueAutoCheck:', e)
  }
